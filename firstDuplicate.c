 ...
 * at 100,000 max elements, this works and passes all tests.
 * 
...
1) rtfm then rtfm again. If I'd seen the 10^5 constraint early, this would have been my first try. 
	My first solution took 5 minutes and passed all but the runtime test, but I spent a boatlod more time
	re-writing and trying to 'patch' that solution, rather then starting clean. I do that a lot....
2) The "smart money" is always so smart. If people are 'n' smart, they will trip over themselves for anything
